...
public class InMemoryEventsRepository implements EventsRepository {
	...
	private List<Events> eventData = new ArrayList<>(Arrays.asList(
			...
			new Events(3L, "E3", "Fun Meeting", "Happy Happy Meeting"),
			new Events(4L, "E4", "Covid Meeting", "Trash Fire FY2020"),
			new Events(5L, "E5", "Advertising Meeting", "Social Media Meeting")));
